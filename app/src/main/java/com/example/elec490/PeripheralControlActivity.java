...
/**
 * https://github.com/devunwired/accessory-samples/blob/master/BluetoothGattPeripheral/src/main/java/com/example/android/bluetoothgattperipheral/PeripheralActivity.java
 * Dave Smith
 * Date: 11/13/14
 * PeripheralActivity
 */
        ...
        public void onCharacteristicWriteRequest(BluetoothDevice device,
            ...
            if (DeviceProfile.CHARACTERISTIC_OFFSET_UUID.equals(characteristic.getUuid())) {
                ...
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(PeripheralControlActivity.this, "Time Offset Updated", Toast.LENGTH_SHORT).show();
                    }
                });
